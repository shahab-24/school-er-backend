...
var resultSnapshot_model_1 = require("./resultSnapshot.model");
    ...
    publish: function (payload) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                ...
                docs = payload.results.map(function (r) { return ({
                    scope: payload.scope,
                ...
                return [2 /*return*/, resultSnapshot_model_1.ResultSnapshot.insertMany(docs, { ordered: true })];
            });
        });
    },
    listByClass: function (params) {
        return __awaiter(this, void 0, void 0, function () {
            var q;
            return __generator(this, function (_a) {
                q = {
                ...
                return [2 /*return*/, resultSnapshot_model_1.ResultSnapshot.find(q).lean()];
            });
        });
    },
    getStudent: function (params) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                ...
                if (params.scope === "terminal")
                    q.terminalKey = params.terminalKey;
                return [2 /*return*/, resultSnapshot_model_1.ResultSnapshot.findOne(q).lean()];
            });
        });
    },
};
