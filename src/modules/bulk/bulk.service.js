...
var idCard_service_1 = require("../id-card/idCard.service");
var typesafe_wrapper_1 = require("../../utils/typesafe-wrapper");
exports.BulkService = {
    generateClassIdCardsZip: function (params, res) {
        return __awaiter(this, void 0, void 0, function () {
            var students, archive, _i, students_1, student, _a, frontPdf, backPdf;
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0: return [4 /*yield*/, student_model_1.Student.find({
                    ...
                    case 2:
                        ...
                        return [4 /*yield*/, idCard_service_1.IDCardService.generatePDF({
                                studentUid: student.studentUid,
                            })];
                    case 3:
                        _a = _b.sent(), frontPdf = _a.frontPdf, backPdf = _a.backPdf;
                        (0, typesafe_wrapper_1.safeArchiveAppend)(archive, frontPdf, {
                            name: "".concat(student.studentUid, "-front.pdf"),
                        });
                        (0, typesafe_wrapper_1.safeArchiveAppend)(archive, backPdf, {
                            name: "".concat(student.studentUid, "-back.pdf"),
                        });
                        _b.label = 4;
                    case 4:
                        _i++;
                        return [3 /*break*/, 2];
                    case 5: return [4 /*yield*/, archive.finalize()];
                    case 6:
                        _b.sent();
                        return [2 /*return*/];
                }
