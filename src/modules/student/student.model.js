 ...
 */
var LocalizedSchema = new mongoose_1.Schema({}, { strict: false, _id: false });
/**
 * Guardian
 */
var GuardianSchema = new mongoose_1.Schema({
    relation: {
        type: String,
 ...
 */
var StipendBeneficiarySchema = new mongoose_1.Schema({
